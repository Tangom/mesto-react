...
function closeAllPopups() {
  ...
  <>
   ...
   <PopupWithForm
            ...
            <input className="popup__field popup__field_career" id='career-input' maxLength="200" minLength="2" name="about"
            ...
            <PopupWithForm
                ...
                children={
                    <>
                 <input className="popup__field popup__field_place" id='place-input' maxLength="30" minLength="1" name="place"
                placeholder="Название" required type="text"/>
            <span className='popup__form-error' id='place-input-error'></span>
            <input className="popup__field popup__field_link" id='link-input' name="link" placeholder="Ссылка на картинку"
              required type="url"/>
            ...
            <PopupWithForm
                ...
                children={
                    <>
                 <input className="popup__field popup__field_link" id='link-avatar-input' name="avatar" placeholder="Ссылка на картинку"
                 required type="url"/>
